...
export default class Profile extends React.Component {
    ...
    componentDidMount() {
        const name = this.props.navigation.getParam('user_code');
        console.log(name)
        this.setState({ 
            loading: true,
            alert: '',
        }, () => { 
            user_model.getUserByUserCode(name).then((response) => {
                if (response == false) {
                    this.setState({
                        loading: false,
                ...
                {this.state.isImageVisible ?
                    this.state.shouldRenderCameraScreen ?
                        <CameraKitCameraScreen
                            ...
                            flashImages={{
                                on: require('./CamaraScreen/images/flashOff.png'),
                                auto: require('./CamaraScreen/images/flashAuto.png')
                            }}
                            cameraFlipImage={require('./CamaraScreen/images/cameraFlipIcon.png')}
                            captureButtonImage={require('./CamaraScreen/images/cameraButton.png')}
                        />
                        :
                        <CameraKitGalleryView
                            ...
                            selection={{
                                selectedImage: require('./CamaraScreen/images/selected.png'),
                            ...
                            fileTypeSupport={{
                                ...
                                unsupportedImage: require('./CamaraScreen/images/unsupportedImage.png'),
                                unsupportedTextColor: '#ff0000'
                            }}
                            customButtonStyle={{
                                image: require('./CamaraScreen/images/openCamera.png'),
